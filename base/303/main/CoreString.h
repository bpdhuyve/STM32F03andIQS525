...
//------------------------------------------------------------------------------------------------//
//STRING INFO FUNCTIONS - these functions return info about the strings but do not modify them
//------------------------------------------------------------------------------------------------//
...
// @remark  returns TRUE if string 1 starts with string 2 (case insensitive, make sure string 2 is all lower case)
...
// @remark  returns TRUE if the search string is found within the source string ignoring upper or lower case
...
//------------------------------------------------------------------------------------------------//
//STRING EDIT FUNCTIONS - these fuctions modify strings, if stuff is added make shure there is enough space available
//------------------------------------------------------------------------------------------------//
...
// @remark  Removes duplicate excessive chars that follow after each other example "testt1" wil become "test1", most used to remove double spaces
...
// @remark  deletes a part of a string at the specified index
void CoreString_Delete(STRING string, U8 index, U8 length);

// @remark  deletes a char in a string at a certain position (the string chars after the indexed char will be advanced 1 position)
void CoreString_DeleteChar(STRING string, U8 index);

//------------------------------------------------------------------------------------------------//
//STRING COPY/CONCAT/SUBSTRING FUNCTIONS
//------------------------------------------------------------------------------------------------//
...
void CoreString_SubString(STRING source_string, STRING destination_string, U16 start_index, U16 length);
