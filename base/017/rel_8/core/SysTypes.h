...
typedef enum
{
    ...
    PIN_ALTERNAT_SPI_NSS_ON_                  = 0x0102,       // OR with alternative function which is pin dependent...
    PIN_ALTERNAT_SPI_SCLK_ON_                 = 0x0102,
    PIN_ALTERNAT_SPI_MISO_ON_                 = 0x0102,
    PIN_ALTERNAT_SPI_MOSI_ON_                 = 0x0102,
    ...
    PIN_ALTERNAT_TIMER1_1_PUSH_PULL           = 0x2102,       //2 = af2, 1=medium speed, 0<<2 no pullup/pull down, 0=pushpull
    PIN_ALTERNAT_TIMER3_1_PUSH_PULL           = 0x1102,       //1 = af1, 1=medium speed, 0<<2 no pullup/pull down, 0=pushpull
    PIN_ALTERNAT_TIMER3_2_PUSH_PULL           = 0x1102,       //1 = af1, 1=medium speed, 0<<2 no pullup/pull down, 0=pushpull
}
SYS_PIN_FUNC;
