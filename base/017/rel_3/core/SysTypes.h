...
#define SCI_CHANNEL_COUNT   2
#define SPI_CHANNEL_COUNT   1
...
typedef enum
{
    ...
    PIN_ALTERNAT_I2C_SCL                      = 0x1312,       // Master I2C 1
    PIN_ALTERNAT_I2C_SDA                      = 0x1312,
    PIN_ALTERNAT_I2C_SCL_PORTA                = 0x4312,       // Master I2C 1 on PORT A
    PIN_ALTERNAT_I2C_SDA_PORTA                = 0x4312,
    
    PIN_ALTERNAT_SPI_SCLK                     = 0x0302,       // Master SPI 1
    PIN_ALTERNAT_SPI_MISO                     = 0x0002,
    PIN_ALTERNAT_SPI_MOSI                     = 0x0302,
    
    PIN_ALTERNAT_SPI_MISO_PULL_UP             = 0x0042,
    PIN_ALTERNAT_SPI_MOSI_PULL_UP             = 0x0342,
    
    PIN_ALTERNAT_SCI_TX                       = 0x1302,       // UART 
    PIN_ALTERNAT_SCI_RX                       = 0x1042,
    PIN_ALTERNAT_SCI_TX_PORTB                 = 0x0302,       // UART 
    PIN_ALTERNAT_SCI_RX_PORTB                 = 0x0042,
}
SYS_PIN_FUNC;
