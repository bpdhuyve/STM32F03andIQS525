...
//------------------------------------------------------------------------------------------------//
static void GlueFunc_AngleChangeAbsolutePostionOnIndexPuls(ANGLE_ID angle_id, U32 value_at_index_puls)
{
    SysAngleQuadEnc_ChangeAbsolutePositionOnIndexPuls((ANGLE_BUS)angle_id, value_at_index_puls);
}
//================================================================================================//
...
void DrvAngleQuadEnc_Init(void)
{
    ...
    angle_hook_list.set_absolute_position_at_indexpuls = GlueFunc_AngleChangeAbsolutePostionOnIndexPuls;
...
//------------------------------------------------------------------------------------------------//
void DrvAngleQuadEnc_RegisterOnEncoderFaults(ANGLE_BUS angle_bus, QUADENC_ENCODERFAULTS_HOOK hook)
{
    SysAngleQuadEnc_RegisterOnEncoderFaults(angle_bus, hook);
}
//================================================================================================//
