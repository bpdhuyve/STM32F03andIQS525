...
//------------------------------------------------------------------------------------------------//
void DrvGpio_TogglePin(DRVGPIO_PIN_HNDL pin_hndl)
{
    //failsafes
    if((pin_hndl == NULL) || (pin_hndl->hook_list_ptr == NULL) || (pin_hndl->hook_list_ptr->get_hook == NULL) || (pin_hndl->hook_list_ptr->set_hook == NULL))
    {
        LOG_WRN("GPIO functions are NULL");
        return;
    }

    //function logic
    pin_hndl->hook_list_ptr->set_hook(pin_hndl->pin_id, (BOOL)!(pin_hndl->hook_list_ptr->get_hook(pin_hndl->pin_id)));
}
//================================================================================================//
