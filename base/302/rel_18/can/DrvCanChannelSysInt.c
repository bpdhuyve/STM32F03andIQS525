...
static BOOL DrvCanChannelSysInt_ConfigBitTimeAnalyser(CAN_CHANNEL_ID channel_id, CAN_TIME_ANALYSE_MODE mode, BOOL capture_all);
...
static BOOL DrvCanChannelSysInt_RegisterBitTimeAnalyseHook(CAN_CHANNEL_ID channel_id, CAN_BIT_TIME_ANALYSE_HOOK bit_time_analyse_hook);
...
static BOOL DrvCanChannelSysInt_ConfigBitTimeAnalyser(CAN_CHANNEL_ID channel_id, CAN_TIME_ANALYSE_MODE mode, BOOL capture_all)
{
    return SysCanInt_Channel_ConfigBitTimeAnalyser((CAN_CHANNEL)channel_id, mode, capture_all);
}
//------------------------------------------------------------------------------------------------//
static BOOL DrvCanChannelSysInt_RegisterRxHook(CAN_CHANNEL_ID channel_id, CAN_RX_NEW_MSSG_HOOK rx_new_byte_hook)
{
...
static BOOL DrvCanChannelSysInt_RegisterBitTimeAnalyseHook(CAN_CHANNEL_ID channel_id, CAN_BIT_TIME_ANALYSE_HOOK bit_time_analyse_hook)
{
    return SysCanInt_Channel_RegisterBitTimeAnalyseHook((CAN_CHANNEL)channel_id, bit_time_analyse_hook);
}
//------------------------------------------------------------------------------------------------//
static BOOL DrvCanChannelSysInt_NotityTxMessageReady(CAN_CHANNEL_ID channel_id)
{
...
void DrvCanChannelSysInt_Init(void)
{
    ...
    can_channel_hook_list.config_bit_time_analyser_hook = DrvCanChannelSysInt_ConfigBitTimeAnalyser;
    ...
    can_channel_hook_list.register_time_analyse_hook = DrvCanChannelSysInt_RegisterBitTimeAnalyseHook;
