...
//------------------------------------------------------------------------------------------------//
DRVSCI_MSG_COMPLETE                         drvscichannel_msg_complete_hook = NULL;
//================================================================================================//
...
{
    LOG_DEV("DrvSciChannel_RegisterMsgComplete");
#if SCI_RS485_COUNT
...
{
    LOG_DEV("DrvSciChannel_RegisterRxHook");
...
{
    LOG_DEV("DrvSciChannel_RegisterTxHook");
