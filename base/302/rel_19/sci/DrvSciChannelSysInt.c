...
#endif
#ifdef INCLUDE_LIN
static BOOL DrvSciChannelSysInt_ConfigAsLin(SCI_CHANNEL_ID channel_id, SCI_CONFIG_STRUCT* config_struct_ptr);
static BOOL DrvSciChannelSysInt_RegisterLinBreakDetectHook(SCI_CHANNEL_ID channel_id, EVENT_CALLBACK lin_break_detected_hook);
static BOOL DrvSciChannelSysInt_SendLinBreak(SCI_CHANNEL_ID channel_id);
#endif
...
static const SCI_CHANNEL_HOOK_LIST          sci_channel_hook_list = {DrvSciChannelSysInt_Config,
                                                                     DrvSciChannelSysInt_RegisterRxHook,
                                                                     DrvSciChannelSysInt_RegisterTxHook,
                                                                     DrvSciChannelSysInt_NotityTxDataReady,
#ifdef INCLUDE_MPCM
                                                                     DrvSciChannelSysInt_ConfigAsMpcm,
                                                                     DrvSciChannelSysInt_SetMpcmFilter,
#else
                                                                     NULL,
                                                                     NULL,
#endif
#ifdef INCLUDE_LIN
                                                                     DrvSciChannelSysInt_ConfigAsLin,
                                                                     DrvSciChannelSysInt_RegisterLinBreakDetectHook,
                                                                     DrvSciChannelSysInt_SendLinBreak
#else
                                                                     NULL,
                                                                     NULL,
                                                                     NULL
...
static BOOL DrvSciChannelSysInt_ConfigAsLin(SCI_CHANNEL_ID channel_id, SCI_CONFIG_STRUCT* config_struct_ptr)
{
    return SysSciInt_Channel_ConfigAsLin((SCI_CHANNEL)channel_id, config_struct_ptr);
}
//------------------------------------------------------------------------------------------------//
static BOOL DrvSciChannelSysInt_RegisterLinBreakDetectHook(SCI_CHANNEL_ID channel_id, EVENT_CALLBACK lin_break_detected_hook)
{
    return SysSciInt_Channel_RegisterLinBreakDetectHook((SCI_CHANNEL)channel_id, lin_break_detected_hook);
}
//------------------------------------------------------------------------------------------------//
static BOOL DrvSciChannelSysInt_SendLinBreak(SCI_CHANNEL_ID channel_id)
{
    return SysSciInt_Channel_SendLinBreak((SCI_CHANNEL)channel_id);
}
#endif
//------------------------------------------------------------------------------------------------//
static void DrvSciChannelSysInt_SysMsgComplete(SCI_CHANNEL channel)
