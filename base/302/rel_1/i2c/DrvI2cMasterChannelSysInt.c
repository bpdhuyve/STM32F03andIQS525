...
//------------------------------------------------------------------------------------------------//
static I2C_CHANNEL_HOOK_LIST                i2c_channel_hook_list;
...
void DrvI2cMasterChannelSysInt_Init(void)
{
    ...
    i2c_channel_hook_list.write_hook = DrvI2cMasterChannelSysInt_WriteData;
    i2c_channel_hook_list.read_hook = DrvI2cMasterChannelSysInt_ReadData;
    i2c_channel_hook_list.config_hook = DrvI2cMasterChannelSysInt_Config;
...
I2C_CHANNEL_HNDL DrvI2cMasterChannelSysInt_Register(I2C_CHANNEL channel)
{
    ...
    if(i2c_channel_count < DRVI2CMASTERCHANNELSYSINT_COUNT)
    {
        ...
        {
            channel_hndl->hook_list_ptr = &i2c_channel_hook_list;
