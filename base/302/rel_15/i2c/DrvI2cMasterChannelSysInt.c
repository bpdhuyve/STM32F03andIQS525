...
//------------------------------------------------------------------------------------------------//
static const I2C_CHANNEL_HOOK_LIST          i2c_channel_hook_list = {DrvI2cMasterChannelSysInt_WriteData, DrvI2cMasterChannelSysInt_ReadData, DrvI2cMasterChannelSysInt_Config};
