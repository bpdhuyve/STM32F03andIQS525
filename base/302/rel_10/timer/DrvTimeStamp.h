...
#include "AppConfig.h"
//------------------------------------------------------------------------------------------------//
#ifndef TIMER__DRVTIMESTAMP_DEFAULT_TIMER
    #error "TIMER__DRVTIMESTAMP_DEFAULT_TIMER not defined"
#endif
//================================================================================================//
...
typedef struct
{
    ...
    U32                             configured_unit_in_ns;
    U32                             configured_unit_scaled;
    U32                             configured_unit_shift;
...
#define TIMESTAMP_TO_NS(timestamp)                          (timestamp * GET_DEFAULT_TIMESTAMP_HANDLE()->configured_unit_in_ns)
//================================================================================================//
