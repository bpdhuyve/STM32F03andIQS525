...
static BOOL DrvI2cMasterChannelBitBang_WriteData_specificSlaveRegister(I2C_CHANNEL_ID channel_id, U8 address, U8* data_ptr, U16 count, U16 slave_reg_address);
static BOOL DrvI2cMasterChannelBitBang_ReadData(I2C_CHANNEL_ID channel_id, U8 address, U8* data_ptr, U16 count);
static BOOL DrvI2cMasterChannelBitBang_ReadData_specificSlaveRegister(I2C_CHANNEL_ID channel_id, U8 address, U8* data_ptr, U16 count, U16 slave_reg_address);
...
//        if(I2cBitBang_WriteByte(i2c_bb_struct_ptr, (U8)((address << 1) & 0xFE)) == TRUE)
//        {
//            DrvI2cMasterChannelBitBang_MsgComplete(channel_id, FALSE);      // NACK received
//            return FALSE;
//        }
//        
//        while(count > 0)
...
//// @param   slave_reg_address: Specifies which register on the slave to read from
static BOOL DrvI2cMasterChannelBitBang_ReadData_specificSlaveRegister(I2C_CHANNEL_ID channel_id, U8 address, U8* data_ptr, U16 count, U16 slave_reg_address)
{
//    I2C_BB_STRUCT*      i2c_bb_struct_ptr = &i2c_bb_struct[channel_id];
//    
...
//        }
//        
//        if(I2cBitBang_WriteByte(i2c_bb_struct_ptr, (U8)(slave_reg_address & 0xFF00) == TRUE))  // write msb of slave register
//        {
//            DrvI2cMasterChannelBitBang_MsgComplete(channel_id, FALSE);      // NACK received
//            return FALSE;
//        }
//        if(I2cBitBang_WriteByte(i2c_bb_struct_ptr, (U8)(slave_reg_address & 0xFF) == TRUE)) // write lsb of slave register 
//        {
//            DrvI2cMasterChannelBitBang_MsgComplete(channel_id, FALSE);      // NACK received
//            return FALSE;
//        }
//        I2cBitBang_StartCond(i2c_bb_struct_ptr);                        // repeat start to initiate read section
//        if(I2cBitBang_WriteByte(i2c_bb_struct_ptr, (U8)((address << 1) & 0xFE) + 1) == TRUE)
//        {
//            DrvI2cMasterChannelBitBang_MsgComplete(channel_id, FALSE);      // NACK
//            return FALSE;
