...
// @remark  will delete all registerd OnAbosutePosition that will occur in the future
void DrvAngle_ClearAllRegisterOnAbsolutePosition(ANGLE_HNDL hndl);

// @remark  will delete all registerd OnAngle that will occur in the future
