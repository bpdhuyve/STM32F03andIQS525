...
//------------------------------------------------------------------------------------------------//
static const SENSOR_HOOK_LIST		sensor_sht21_hook_list = {DrvSensorSensirionSht21_IsPresent, DrvSensorSensirionSht21_ReadSensor, DrvSensorSensirionSht21_GetValue};
