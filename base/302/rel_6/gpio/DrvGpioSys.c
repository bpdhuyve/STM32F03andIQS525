...
static const GPIO_DRV_HOOK_LIST     gpio_pin_hook_list = {NULL, DrvGpioSys_SetPin, DrvGpioSys_GetPin};
#if DRVGPIOSYS_MAX_SWITCH_PINS
static SWITCH_STRUCT                gpio_switch_struct[DRVGPIOSYS_MAX_SWITCH_PINS];
static U8                           gpio_switch_count;
static const GPIO_DRV_HOOK_LIST     gpio_pin_hook_switch_list = {DrvGpioSys_ReInitPin, DrvGpioSys_SetPin, DrvGpioSys_GetPin};
#endif
//================================================================================================//
...
BOOL DrvGpioSys_EnableSwitch(DRVGPIO_PIN_HNDL pin_hndl, SYS_PIN_FUNC input_pin_func, SYS_PIN_FUNC output_pin_func)
{
    ...
    if(gpio_switch_count < DRVGPIOSYS_MAX_SWITCH_PINS)
    {
        ...
        pin_hndl->hook_list_ptr = (GPIO_DRV_HOOK_LIST*)&gpio_pin_hook_switch_list;
        gpio_switch_count++;
        return TRUE;
    }
    return FALSE;
