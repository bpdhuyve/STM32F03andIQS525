...
typedef BOOL (*CAN_CONFIG_BIT_TIME_ANALYSER)(CAN_CHANNEL_ID channel_id, CAN_TIME_ANALYSE_MODE mode, BOOL capture_all);
...
typedef BOOL (*CAN_REGISTER_TIME_ANALYSE_HOOK)(CAN_CHANNEL_ID channel_id, CAN_BIT_TIME_ANALYSE_HOOK bit_time_analyse_hook);
...
void DrvCanChannel_FillExtDataFrameMuxMssgStruct(CAN_MSSG_STRUCT* mssg_ptr, U32 identifier, U8 mux, U8 data_length, U8* data_ptr);
//================================================================================================//
