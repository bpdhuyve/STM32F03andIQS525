...
U16 DrvStepperAmis30422_GetErrorMask(AMIS30422_HNDL amis_hndl)
{
    ...
    if((amis_hndl != NULL) && (amis_hndl->amis_id < amis_count))
    {
        error_mask = ((U16)(DrvStepperAmis30422_ReadRegister(amis_hndl, AMIS30422_REGISTER_SR0) & 0x7C)) >> 4;
        error_mask |= ((U16)(DrvStepperAmis30422_ReadRegister(amis_hndl, AMIS30422_REGISTER_SR1) & 0x7C)) << 2;
        error_mask |= ((U16)(DrvStepperAmis30422_ReadRegister(amis_hndl, AMIS30422_REGISTER_SR2) & 0x7C)) << 8;
        return error_mask;
    }
    LOG_ERR("%s%d", PCSTR(drvstepper_illegal_device_string), PU8(amis_hndl->amis_id));
    return 0;
