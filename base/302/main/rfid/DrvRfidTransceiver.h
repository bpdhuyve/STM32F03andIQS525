...
typedef BOOL (*RFID_TRANSCEIVER_CALCULATE_CRC) (RFID_TRANSCEIVER_ID transceiver_id, U8 *data, U8 data_length, U8 *crc_buffer);
...
typedef RFID_ERROR (*RFID_TRANSCEIVER_TRANSCEIVERX)(RFID_TRANSCEIVER_ID transceiver_id, U8* tx_buffer_ptr, U8 tx_buffer_length, U8* rx_buffer_ptr, U8* rx_buffer_length);

typedef RFID_ERROR (*RFID_TRANSCEIVER_AUTHENTICATE)(RFID_TRANSCEIVER_ID transceiver_id, U8 block_address, U8* key_ptr, U8* uid_ptr, U8 uid_length);

typedef void (*RFID_TRANSCEIVER_STOP_ENCRYPTION)(RFID_TRANSCEIVER_ID transceiver_id);

typedef BOOL (*RFID_TRANSCEIVER_SETTIMER)(RFID_TRANSCEIVER_ID transceiver_id, U16 micro_seconds);
...
typedef struct
{
    ...
    RFID_TRANSCEIVER_CALCULATE_CRC                      calculate_crc_hook;
    RFID_TRANSCEIVER_SET_RF_FIELD                       set_rf_field_hook;
    RFID_TRANSCEIVER_TRANSCEIVE                         transceive_hook;
    RFID_TRANSCEIVER_TRANSCEIVERX                       transceiveRx_hook;
    RFID_TRANSCEIVER_AUTHENTICATE                       authenticate_hook;
    RFID_TRANSCEIVER_STOP_ENCRYPTION                    stop_encryption_hook;
    RFID_TRANSCEIVER_SETTIMER                           set_timer_hook;
...
BOOL DrvRfidTransceiver_SetTimer(RFID_TRANSCEIVER_HNDL, U16 micro_seeconds);
