...
//------------------------------------------------------------------------------------------------//
#include "Core.h"
#include "slider\DrvSliderSx8644.h"
//================================================================================================//
...
static void Configure_SX8644_Plexi(void);
static BOOL DrvSliderSx8644_Get(U8 slider_id, U16* slider_value_ptr);
...
static void Configure_SX8644_Plexi(void)
{
    ...
    writeBuffer[4] = 0xAA;//CapMode7_4
    writeBuffer[5] = 0xAA;//CapMode3_0
    writeBuffer[6] = 0x66;//Capsense0_1             -----> IMPORTANT
    writeBuffer[7] = 0x55;//Capsense2_3
    writeBuffer[8] = 0x55;//Capsense4_5
    do
    {
    ...
    writeBuffer[0] = 0x00;//Indicating 8ConWriteByte
    writeBuffer[1] = 0xA0;//CapTresh5
    writeBuffer[2] = 0xA0;//CapTresh6
    writeBuffer[3] = 0xA0;//CapTresh7
    writeBuffer[4] = 0xA0;//CapTresh8
    writeBuffer[5] = 0xA0;//CapTresh9
    writeBuffer[6] = 0xA0;//CapTresh10
    writeBuffer[7] = 0xA0;//CapTresh11
    writeBuffer[8] = 0x00;//CapPerComp
    do
    {
...
SLIDER_HNDL DrvSliderSx8644_Register(I2C_CHANNEL_HNDL i2c_channel, U8 address)
{
    ...
    Configure_SX8644_Plexi();
    //Configure_SX8644();

    slider_struct.get_value_hook = DrvSliderSx8644_Get;//Addres of function in the hook
