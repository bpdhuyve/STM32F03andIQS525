...
//------------------------------------------------------------------------------------------------//
static SLIDER_STRUCT        subslider_handles[DRVSLIDER_SUBSLIDER_COUNT];
...
//SLIDER 	DrvSlider_CreateBufferedSlider(SLIDER slider);
//void	DrvSlider_RefhreshBufferedSlider(SLIDER slider);
//------------------------------------------------------------------------------------------------//
