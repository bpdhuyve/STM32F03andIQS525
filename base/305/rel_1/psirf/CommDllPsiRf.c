                       ...
                       DRVGPIO_PIN_HNDL gdo2_pin_hndl)
{
    ...
    dllpsirf_inbox_q_hndl = CoreQ_Register(STDDLLPSIRF_QUEUE_SIZE, SIZEOF(DLL_PSIRF_MSG), "CommDllPsiRf_InboxQ");
...
#if STDDLLPSIRF_HANDLER_FROM_INTERRUPT_TIMEOUT
    stddlpsirf_timeout_handler_task = CoreTask_RegisterTask((U32)STDDLLPSIRF_HANDLER_FROM_INTERRUPT_TIMEOUT * 1e3,
                                                          DllPsiRfOnHandlerTimeOut,
                                                          NULL,
                                                          64,
                                                          "CommDllPsiRfHandlerTO");
#endif
#if STDDLLPSIRF_CALIBRATION_TIMEOUT
    stddlpsirf_timeout_counter = 0;
