...
static     const STRING    dll_states[] = {"INIT", "IDLE", "RX_ACTIVE", "TX_LOADED", "TX_ACTIVE"};
//================================================================================================//
                       ...
                       DRVGPIO_PIN_HNDL gdo2_pin_hndl)
{
    ...
    dllpsirf_registers[CC1101_IOCFG2] = 0x02;
    dllpsirf_registers[CC1101_IOCFG0] = 0x02;        // TX THR indication
    dllpsirf_registers[CC1101_FIFOTHR] = 0x4D;       // TX THR @ 9 bytes
    dllpsirf_registers[CC1101_PKTLEN] = STDDLLPSIRF_FRAME_LENGTH;    // max length of received msg
    dllpsirf_registers[CC1101_PKTCTRL1] = 0x00;      // no crc auto flash, no status append
    dllpsirf_registers[CC1101_PKTCTRL0] = 0x02;      // infinite packet length
    dllpsirf_registers[CC1101_MCSM2] = 0x07;
    dllpsirf_registers[CC1101_MCSM1] = 0x0F;         // no CCA
