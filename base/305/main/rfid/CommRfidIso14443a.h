...
/**
*@brief	Used to detect ISO14443A conform PICCs
*       In case a PICC is detected, it will have passed the anticollision loop and will be selected.
