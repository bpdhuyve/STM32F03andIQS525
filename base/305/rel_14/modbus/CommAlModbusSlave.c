...
#ifndef MODBUS_MAX_FRAME_LENGTH
    #error "MODBUS_MAX_FRAME_LENGTH not defined in AppConfig.h"
#endif
//================================================================================================//
...
static BOOL CommAlModbusSlave_CheckSubReq20(U8* data_ptr)
{
    ...
    if(length_temp > (MODBUS_MAX_FRAME_LENGTH - 2))       //-2 because of func code and resp.data length
    {
...
static void CommAlModbusSlave_HandleData(MODBUS_CHANNEL modbus_channel, U8* data_ptr, U8  length, U8* reply_data_ptr, U8* reply_length_ptr)
{
    ...
    U8  j;
    U8  byte_cnt;
    static U16  output_value_ptr[MODBUS_MAX_FRAME_LENGTH / 2];
