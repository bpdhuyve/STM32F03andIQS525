...
// @remark   draws a text @ location in the buffer , if the style is debug_style then a low flash cost font debug font is used (background color is black and front color is white)
void StdDraw_DrawText(POINT location, STYLE style, STRING text);

// @remark   move a region in the display buffer to a new location
