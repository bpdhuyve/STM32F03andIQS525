...
//------------------------------------------------------------------------------------------------//
#define RANGE_U8                    0, 1, 0xFF
#define RANGE_S8                    0xFFFFFF80, 1, 0x7F
#define RANGE_U16                   0, 1, 0xFFFF
#define RANGE_S16                   0xFFFF8000, 1, 0x7FFF
#define RANGE_U32                   0, 1, 0xFFFFFFFF
#define RANGE_S32                   0x80000000, 1, 0x7FFFFFFF
//================================================================================================//
...
// @remark  Function to register a info list. Use LIST_REF(x) macro for easier referencing
// @remark  Info lists do not allow StdParameter_SetPara()
// @return  Returns a handle, LOG_ERR is called if PARAMETER_LIST_COUNT is insufficient
...
// @remark  not allowed on info lists
